    ...
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
            <span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon">
                ...
                </svg></span><span>Магазин SOUNDPAD</span></a>
        <div class="d-flex">
            <div class="input-group me-2"><span class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    type="button">Поиск</button></div><a href="{{ route('cart') }}" class="btn btn-primary me-2" type="button"><svg
                    xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16"
                    class="bi bi-cart">
                    <path
                        d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2">
                    </path>
                </svg></a><a href="{{ route('profile') }}" class="btn btn-primary" type="button"><svg xmlns="http://www.w3.org/2000/svg"
